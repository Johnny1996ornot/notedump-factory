    ...
    <div id="main-stage">
        <div id="workspace">
            ...
            <div id="canvas-global-tools" style="display:none;">
                ...
                <label style="font-size: 11px; display: flex; align-items: center; gap: 4px; cursor: pointer; color: var(--text); font-weight: bold; white-space: nowrap; margin-left: 8px;">
                    ...
                    <div id="canvas">
                        ...
                        <div id="context-menu" style="display:none; position:absolute; flex-direction:column; gap:4px; padding:8px 10px; border-radius:8px; background:white; border: 1px solid #cbd5e1; box-shadow: 0 4px 15px rgba(0,0,0,0.3); z-index:10000;">
                            ...
                            <div style="display:flex; gap:6px; align-items:center; padding: 2px;">
                                <div id="menu-drag-handle" title="Drag to move element" style="cursor: move; padding: 0 4px; color: #4f46e5;"><i class="fas fa-arrows-alt"></i></div>
            ...
            <div id="pin-panel" class="floating-panel">
                ...
                <div class="panel-body" style="padding-top: 15px;">
                    <div style="display:flex; gap:10px; margin-bottom: 15px; padding: 0 15px;">
                        <button onclick="$('#canvas').toggleClass('hide-pins')" style="background:#475569; color:white; border:none; padding:8px; border-radius:4px; cursor:pointer; width:100%; font-weight:bold;" title="Hide all annotations from the page"><i class="fas fa-eye-slash"></i> Toggle Visibility</button>
                    </div>
