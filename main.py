...
/* Strip out all hidden gap padding generated by Streamlit's element containers */
...
/* =========================================
   ...
   ========================================= */
/* We force both the exact uploader dropzone AND the download button to be identical in every dimension */
...
/* NUCLEAR OPTION: Hide EVERYTHING inside the uploader wrapper EXCEPT the main dropzone. 
   This destroys the ghost label wrapper causing the gap. */
[data-testid="stFileUploader"] > *:not(section) {
    display: none !important;
...
[data-testid="stFileUploadDropzone"] { 
    ...
    justify-content: center !important; 
    align-items: center !important; 
    padding: 20px !important; /* Internal padding only */
}
